          ...
          <View style={styles.container}>
            ...
            this.props.data.map((data)=>(
              <View style={styles.displaybox}>
                ...
                <Image style={{height:160,width:160,resizeMode:'contain'}} source={data.image}></Image>
                    ...
                    <View style={styles.descriptionview}>
                        ...
                        <Ionicons style={{fontSize:10,color:'#7CB944'}} name="star" ></Ionicons>
                        ...
                        <Text style={{fontSize:10,color:'#8F8F8F'}}>{data.rating}</Text>
                            ...
                            <EvilIcons style={{fontSize:25,color:'#8F8F8F'}} name="chevron-down" ></EvilIcons>
                            </TouchableOpacity>
